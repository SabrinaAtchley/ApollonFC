...
namespace SpeedController {
  ...
  #define SPEED_CONTROLLER_CALIBRATE(SIGNALS) SPEED_CONTROLLER_WRITE_ALL(SIGNALS, INPUT_MOTOR_MAX); delay(8000); SPEED_CONTROLLER_WRITE_ALL(SIGNALS, INPUT_MOTOR_MIN); delay(3000);
